...
int action(QDomElement c, QFormatFactory *f, QHash<QString, int>& pids)
{
	int fid = 0;
...
void fillContext(QNFA *cxt, QDomNodeList l, QFormatFactory *f, QHash<QString, int>& pids, bool cs);

void addToContext(	QNFA *cxt, QDomElement c, int fid,
					QFormatFactory *f, QHash<QString, int>& pids,
