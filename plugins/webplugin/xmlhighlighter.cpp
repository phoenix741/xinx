...
webplugin_xml::webplugin_xml( QObject* parent, XINXConfig * config ) : SyntaxHighlighter( parent, config ) {
...
webplugin_xml::webplugin_xml( QTextEdit* parent, XINXConfig * config ) : SyntaxHighlighter( parent, config ) {
