...
public:
	...
	const QList<WSDLPart> & parts() const
	{
		return m_parts;
	};
private:
...
public:
	...
	QString inputEncodingStyle() const
	{
		return m_inputEncodingStyle;
	};
	QString outputEncodingStyle() const
	{
		return m_outputEncodingStyle;
	};

	QString inputNamespace() const
	{
		return m_inputNamespace;
	};
	QString outputNamespace() const
	{
...
public:
	...
	const QList<WSDLOperation> & operations() const
	{
		return m_operations;
	};
private:
...
public:
	...
	QString addressLocation() const
	{
		return m_addressLocation;
	};
private:
	QString m_name;
	QString m_binding;
...
public:
	...
	const QHash<QString,WSDLType> & types() const
	{
		return m_types;
	};
	const QHash<QString,WSDLMessage> & messages() const
	{
		return m_messages;
	};
	const QHash<QString,WSDLBinding> & bindings() const
	{
		return m_bindings;
	};
	const QHash<QString,WSDLPortType> & portTypes() const
	{
		return m_portTypes;
	};
	const QList<WSDLService> & services() const
	{
		return m_services;
	};
private:
