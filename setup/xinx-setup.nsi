...
LangString SEC_XNX_APP_DESC ${LANG_FRENCH} "Le necessaire au démarrage de l'application XINX et à l'utilisation des foncitonnalités de base"
LangString SEC_EXT_SCRIPT_DESC ${LANG_FRENCH} "Des scriptes supplémentaire pour l'utilisation de XINX"
