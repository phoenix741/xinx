...
void TextEditor::mouseDoubleClickEvent( QMouseEvent * event ) {
    ...
    while ( pos>0  && QString("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_¿¡¬ƒ√≈∆«»…À ÃÕŒœ“‘’÷Ÿ⁄€‹›").contains( m_plainText.at( pos-1 ).toUpper()  ) )
        pos--;
    cursor.setPosition(pos, QTextCursor::MoveAnchor);
    setTextCursor( cursor );
    //
    while ( pos < m_plainText.length()  && QString("ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_¿¡¬ƒ√≈∆«»…À ÃÕŒœ“‘’÷Ÿ⁄€‹›").contains( m_plainText.at( pos ).toUpper()  ) )
        pos++;
